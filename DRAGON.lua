...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ↓ :\na≪━━━━━━☩☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎☩━━━━━━≫\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m≪━━━━━━☩☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎☩━━━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m≪━━━━━━☩☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎☩━━━━━━≫ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
if tonumber(user_id) == tonumber(1885561364) then  
var = 'قــلـب مـــــــاب ♡'
elseif tonumber(user_id) == tonumber(1704169652) then
var = 'مبرمج السورس¹'  
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
var = "قـــــــلب مـــــــاب ♡"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = 'البوت'
elseif database:sismember(bot_id..'Sudo:User', user_id) then
...
local UserName = (data.username_ or "SouRce_Mab")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ☩☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎☩")  
...
if text == '☾︎♫︎ 𝗗𝗘𝗩 𝗙𝗥𝗘𝗫𝗔𝗦 ♫︎☽︎' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[LUCIFER](t.me/FreXaS_1)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '', url="t.me/FreXaS_1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '☾︎♫︎ 𝗗𝗘𝗩 𝗠𝗔𝗕 ♫︎☽︎' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[☾︎♫︎ 𝗗𝗘𝗩 𝗠𝗔𝗕 ♫︎☽︎]( t.me/xO_mab_Ox)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '', url=" t.me/xO_mab_Ox"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/SouRce_Mab"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/ARROW55_bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝗧𝘄𝗮𝘀𝗼𝗹', url="t.me/ARROW55_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n ★ العضو » ['..result.title_..'](t.me/'..(username or 'SouRce_Mab')..')'
status  = '\n ★ تم ترقيته مطور'
...
usertext = '\n ★ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SouRce_Mab')..')'
status  = '\n ★ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ★ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SouRce_Mab')..') \n ★ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ★ العضو : {["..data.first_name_.."](T.ME/SouRce_Mab)}\n ★ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ★ عذرا » {["..data.first_name_.."](T.ME/SouRce_Mab)}\n ★ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
★W𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 ☾︎♫︎  𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎★
★مرحبا بك في سورس اررو الاعظم★
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☾︎♫︎ 𝗗𝗘𝗩 𝗠𝗔𝗕 ♫︎☽︎',url="t.me/xO_mab_Ox"}},
{{text = '☾︎♫︎ 𝗗𝗘𝗩 𝗙𝗥𝗘𝗫𝗔𝗦 ♫︎☽︎',url="t.me/FreXaS_1"}},
{{text = '☾︎♫︎ 𝐓W𝐀𝐒𝐎𝐋 ♫︎☽︎',url="t.me/ARROW55_bot"}},
{{text = '☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘  ♫︎☽︎', url="t.me/SouRce_Mab"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == '☾︎♫︎ 𝗗𝗘𝗩 𝗠𝗔𝗕 ♫︎☽︎' or text == 'ماب' or text == 'المبرمج' then
local Text = [[
[☾︎♫︎ ??𝗘𝗩 𝗠𝗔𝗕 ♫︎☽︎](t.me/xO_mab_Ox)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☾︎♫︎ 𝗗𝗘𝗩 𝗠𝗔𝗕 ♫︎☽︎',url=" t.me/xO_mab_Ox"}},
...
if text == 'فريكساس' or text == 'قلب ماب ' or text == 'المبرمج' then
local Text = [[
[☾︎♫︎ 𝗗𝗘𝗩 𝗙𝗥𝗘𝗫𝗔𝗦 ♫︎☽︎](t.me/FreXaS_1)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☾︎♫︎ 𝗗𝗘𝗩 𝗙𝗥𝗘𝗫𝗔𝗦 ♫︎☽︎',url="t.me/FreXaS_1"}},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝙨𝙤𝙪𝙧𝙘𝙚', url="t.me/SouRce_Mab"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '☩☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎☩', url=" t.me/xO_mab_Ox"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/xO_mab_Ox&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '☩☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎☩', url="t.me/FreXaS_1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/xO_mab_Ox&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العاب متطوره' or text == 'العاب السورس' or text == 'العاب اررو' then
local Text = [[
𝐒𝐎𝐔𝐑𝐂𝐄 ☾︎♫︎ 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎
]]
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ★ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SouRce_Mab')..') \n ★ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ★ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SouRce_Mab')..') \n ★ تـم قفـل التاك بالكتم ')
end,nil)   
...
if result.sender_user_id_ == tonumber(1704169652) then
send(msg.chat_id_, msg.id_, " ★ لا يمكنك حظر المبرمج فريكساس\n")
return false 
end
if result.sender_user_id_ == tonumber(1885561364) then
...
if tonumber(result.id_) == tonumber(1885561364) then  
send(msg.chat_id_, msg.id_, " ★ ده بابا عيب")
return false 
end
if tonumber(result.id_) == tonumber(1704169652) then  
send(msg.chat_id_, msg.id_, " ★ لا تسطيع حظر المبرمج فريكساس عام")
return false 
end
...
if result.sender_user_id_ == tonumber(1704169652) then
send(msg.chat_id_, msg.id_, " ★ لا يمكنك كتم المبرمج فريكساس \n")
return false 
end
if result.sender_user_id_ == tonumber(1885561364) then
send(msg.chat_id_, msg.id_, " ★ ده بابا عيب\n")
...
if tonumber(result.id_) == tonumber(1704169652) then  
send(msg.chat_id_, msg.id_, " ★ لا تسطيع كتم المبرمج فريكساس عام")
return false 
end
if tonumber(result.id_) == tonumber(1885561364) then  
send(msg.chat_id_, msg.id_, " ★ ده بابا عيب")
...
local TextE = "\n≪━━━━━━☩☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎☩━━━━━━≫\n ★ علامة تعني { ✔️ } ملف مفعل\n ★ علامة تعني { ✖ } ملف معطل\n ★ قناة سورس ايفيل ↓\n".." ★ [اضغط هنا لدخول](t.me/SouRce_Mab) \n"
local NumFile = 0
...
Reply_Status(msg,result.sender_user_id_,"reply","★ اررويله من المطور ثانويين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","★ اررويله من المطور ثانويين")  
else
send(msg.chat_id_, msg.id_,"★ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","★ اررويله من المطور ثانويين")  
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ★ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SouRce_Mab')..')'
status  = '\n ★ اررويله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ★ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SouRce_Mab')..')'
status  = '\n ★ اررويل العضــو الزوجات من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ★ اررويل جميع حمير من الجروب')
end
...
send(msg.chat_id_, msg.id_, ' ★ اررويل جميع وتكات الجروب')
end
...
send(msg.chat_id_, msg.id_, ' ★ اررويل جميع القرده بالجروب')
end
...
send(msg.chat_id_, msg.id_, ' ★ اررويل جميع الارامل بالجروب')
end
...
send(msg.chat_id_, msg.id_, ' ★ اررويل جميع الخولات بالجروب')
end
...
send(msg.chat_id_, msg.id_, ' ★ اررويل جميع البقرات بالجروب')
end
...
send(msg.chat_id_, msg.id_, ' ★ اررويل جميع المزز بالجروب')
end
...
send(msg.chat_id_, msg.id_, ' ★ اررويل جميع االاكساس')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SouRce_Mab')..')'
status  = '\n ★  الايدي » `'..result.sender_user_id_..'`\n ★  اررويله ادمن من الجروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ★ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SouRce_Mab')..')'..'\n ★ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'فريكساس') 
...
database:set(bot_id.."SouRce_Mab:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."SouRce_Mab:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."SouRce_Mab:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."SouRce_Mab:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"★تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."SouRce_Mab:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."SouRce_Mab:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SouRce_Mab')..')'
local iduser = result.sender_user_id_
...
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = '❤ المالك ي رحقلبي '
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = '😂انت مشرف عادي يعن😂 ' 
elseif da.status_.ID == "ChatMemberStatusMember" then 
rtpa = ' 😂 انت عضو كحيان يستا '
end
...
local Text =[[
𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 ☩☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎☩
◎⟼⟼⟼⟼⟼☩☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎☩⟻⟻⟻⟻⟻◎
...
{text = 'مبرمج السورس', url="t.me/xO_mab_Ox"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'≪━━━━━━☩☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎☩━━━━━━≫ٴ\n★ [ ☩☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎☩ ](t.me/SouRce_Mab)')
end
